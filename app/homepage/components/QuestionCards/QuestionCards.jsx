    ...
    {endGamePass ? (
      ...
      <div className="w-full">
        ...
        <div className="flex flex-col items-center justify-center h-screen space-y-2">
          ...
          {questions.length > 0 && (
            <legend className="text-lg font-bold text-center md:text-lg lg:text-xl">{questions[0].question.text}</legend>
          )}
          <div className="space-y-4 w-full max-w-md">
            {shuffledAnswers.map((answer, index) => (
              <div 
                ...
                />
                <label htmlFor={`Answer${index + 1}`} className="text-lg md:text-lg lg:text-xl">
                  {answer}
                </label>
              </div>
            ))}
